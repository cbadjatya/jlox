...
input2 = [["Stmt","stmt"], ["Expression",["Expr", "expr"]],["Print",["Expr", "expr"]]]
...
def astGen(input):
    ...
    source += "package jlox;\n\n"
    source += "abstract class " + input[0][0] + "{\n\n"
    ...
    for l in input[1:]:
        ...
        source += "\t\tR "
        source += "visit"+class_name+input[0][0]+"("+class_name+" "+input[0][1]+");\n"
    ...
    for l in input[1:]:
        ...
        # add class
        source += "\tstatic class " + class_name + " extends " + input[0][0] + "{\n\n"
        ...
        source += "\t\t\treturn visitor.visit"+class_name+input[0][0]+"(this);"
        source += "\n\t\t}"
    ...
    relative_path = "../jlox/"+input[0][0]+".java"
